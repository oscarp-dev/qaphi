  ...
  return (
    <section className="relative min-h-screen bg-cream md:grid md:grid-cols-[1fr_1.3fr]">
      ...
      <div className="relative z-[1] flex min-h-screen flex-col justify-end gap-6 px-[6vw] pb-16 pt-24 md:min-h-0 md:order-1 md:justify-center md:gap-10 md:py-[9vw]">
        <Eyebrow className="!text-cream [text-shadow:0_2px_16px_rgba(59,38,29,0.45)] md:!text-umber md:[text-shadow:none]">
          ALICANTE
        </Eyebrow>
        <h1 className="m-0 font-serif font-normal leading-[0.92] text-cream text-[clamp(56px,15vw,140px)] [text-shadow:0_6px_24px_rgba(59,38,29,0.45)] md:text-ink md:text-[clamp(64px,8.2vw,140px)] md:[text-shadow:none]">
          QAPHI
        </h1>
        <p className="m-0 max-w-[340px] text-[clamp(20px,2.2vw,26px)] leading-relaxed text-cream/95 [text-shadow:0_2px_12px_rgba(59,38,29,0.4)] md:text-umber md:[text-shadow:none]">
